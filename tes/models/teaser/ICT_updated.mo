...
within teaser_district_cooling.Loads.B5a6b99ec37f4de7f94020090;
model ICT
  ...
  parameter Real fraLat=1.24 "Fraction latent of sensible persons load = 0.8 for home, 1.25 for office.";
  ...
  Buildings.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[4](    each outSkyCon=true,
    ...
    ,
    azi = {0.0, 1.5707963267948966, 3.141592653589793, -1.5707963267948966})
  ...
  thermalZoneFourElements(
    redeclare package Medium = a new value,
    VAir=99898989898.99998,
    hConExt=2.6999999999999997,
    hConWin=2.7000000000000006,
    gWin=0.6700000000000002,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={0.000698239843222835},
    CExt={16436365.53309284},
    hRad=5.0,
    AInt=554.8883284000001,
    hConInt=2.4714285714285715,
    nInt=1,
    RInt={0.0001402605618053111},
    CInt={54299149.2103404},
    RWin=0.027484237646595907,
    RExtRem=0.0461903785492336,
    AFloor=36.46409015200001,
    hConFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.0006342850630286857},
    RFloorRem=0.043375092329153014,
    CFloor={2933509.408281059},
    ARoof=36.46409015200001,
    hConRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.0006523702279482124},
    RRoofRem=0.05294659374703131,
    CRoof={13340864.552574946},
    ...
    nOrientations=4,
    AWin={5.963815724622265, 0.5528095467402644, 5.963815724622265, 0.5528095467402644},
    ATransparent={5.963815724622265, 0.5528095467402644, 5.963815724622265, 0.5528095467402644},
    AExt={17.891447173866798, 1.658428640220793, 17.891447173866798, 1.658428640220793}, nPorts=nPorts, use_moisture_balance=use_moisture_balance)
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.45758467583140006, 0.04241532416859992, 0.45758467583140006, 0.04241532416859992},
    wfWin={0.45758467583140006, 0.04241532416859994, 0.45758467583140006, 0.04241532416859994},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*39.099751628175184)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*13.033250542725057)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    tableName="Internals",
    fileName=Modelica.Utilities.Files.loadResource("modelica://teaser_district_cooling/Loads/Resources/Data/B5a6b99ec37f4de7f94020090/InternalGains_ICT.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=911.6022538000005)
