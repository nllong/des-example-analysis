within doe_small_demo_high_eff.Plants;
model CentralCoolingPlant
  ...
  parameter Modelica.Units.SI.Temperature TCW_nominal
    ...
    annotation (Dialog(group="Cooling Tower"));
  parameter Modelica.Units.SI.TemperatureDifference dT_nominal=6.56
  ...
  parameter Modelica.Units.SI.Temperature TMin
    ...
    annotation (Dialog(group="Cooling Tower"));
  parameter Modelica.Units.SI.Power PFan_nominal=4999
     "Fan power"
    annotation (Dialog(group="Cooling Tower"));
  // pump parameters
  ...
  parameter Modelica.Units.SI.Pressure dpCHWPum_nominal=300000
     "Nominal pressure drop of chilled water pumps"
    annotation (Dialog(group="Pump"));
  parameter Modelica.Units.SI.Pressure dpCWPum_nominal=200000
  ...
  Buildings.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    ...
    filNam=Modelica.Utilities.Files.loadResource(
      "modelica://doe_small_demo_high_eff/Resources/Data/Plants/USA_NY_Buffalo-Greater.Buffalo.Intl.AP.725280_TMY3.mos"))
