within high_eff_demo.Substations;
model CoolingIndirect_12
  ...
  parameter Modelica.Units.SI.MassFlowRate mDis_flow_nominal(
    final min=0,
    start=183.52100000000002)
     "Nominal mass flow rate of primary (district) cooling side";
  parameter Modelica.Units.SI.MassFlowRate mBui_flow_nominal(
    final min=0,
    start=29.857)
     "Nominal mass flow rate of secondary (building) cooling side";
